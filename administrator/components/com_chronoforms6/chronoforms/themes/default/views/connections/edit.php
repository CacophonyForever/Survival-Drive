						...
						<div class="content<?php if(empty($kfg)): ?> active<?php endif; ?>">
							...
							<div class="ui grid center aligned small functions-list">
								<?php foreach($functions_info2[$type] as $fn_name => $fn_info): ?>
									...
									<div class="eight wide large screen sixteen wide small screen column draggable" data-type="function" data-private="<?php echo !empty($fn_info['private']) ? 1 : 0; ?>" data-info='<?php echo json_encode($fn_info); ?>' style="padding:5px;">
						...
						<div class="content <?php if(empty($kvg)): ?> active<?php endif; ?>">
							...
							<div class="ui grid center aligned small views-list">
								<?php foreach($views_info2[$type] as $vw_name => $vw_info): ?>
									...
									<div class="eight wide large screen sixteen wide small screen column draggable" data-type="view" data-info='<?php echo json_encode($vw_info); ?>' style="padding:5px;">
