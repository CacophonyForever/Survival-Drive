...
<div class="ui segmenthh events-tab main-event" data-tab="events-<?php echo $name; ?>">
	...
	<div class="ui top attached tabular menu G2-tabs">
		...
		<div class="item right" data-tab="events-<?php echo $name; ?>-tools">
			<i class="icon <?php if(!empty($this->data('Connection.events.'.$name.'.minimized'))):?>maximize<?php else: ?>minimize<?php endif; ?> teal link minimize_link" data-hint="<?php el('Minimize/Maximize'); ?>" data-named="<?php echo $name; ?>"></i>
