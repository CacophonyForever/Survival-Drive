...
<div class="ui segment tab functions-tab active" data-tab="functions-<?php echo $n; ?>">
	...
	<div class="ui top attached tabular menu small G2-tabs">
		...
		<a class="item" data-tab="functions-<?php echo $n; ?>-encryption"><?php el('Encryption'); ?></a>
	...
	<div class="ui bottom attached tab segment" data-tab="functions-<?php echo $n; ?>-encryption">
