...
<form action="<?php echo r2('index.php?ext=chronofc&cont=connections'); ?>" method="post" name="admin_form" id="admin_form" class="ui form">
	...
	<a class="ui header" href="<?php echo r2('index.php?ext=chronofc&cont=tables&name='.$this->data('table_name')); ?>"><i class="icon left chevron"></i> <?php echo $this->data('table_name'); ?></a>
